...
public class PersonBean implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 79 * hash + Objects.hashCode(this.lastAccess);
    ...
    public String toString() {
        return "PersonBean{" + "idPerson=" + idPerson + ", login=" + login + ", email=" + email + ", password=" + password + ", fullName=" + fullName + ", status=" + status + ", privilege=" + privilege + ", lastAccess=" + lastAccess + ", lastPasswordChange=" + lastPasswordChange + '}';
    }
}
